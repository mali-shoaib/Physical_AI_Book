...
const config = {
  ...
  tagline: 'AI-Native Textbook for Robotics Students',
  favicon: 'img/favicon.svg',

  // Set the production url of your site here
  url: 'https://physical-ai-robotics-textbook-6vdwfwbax-mali-shoaibs-projects.vercel.app',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/your-org/books/tree/main/',
          lastVersion: 'current',
          versions: {
            current: {
              label: '1.0 (Current)',
        ...
        blog: false, // Disable blog for textbook use case
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/your-org/books',
            label: 'GitHub',
            position: 'right',
            target: '_blank',
